...
static char __pyx_k_ERROR_SUCCESS[] = "ERROR_SUCCESS";
static char __pyx_k_ERROR_INSUFFICIENT_BUFFER[] = "ERROR_INSUFFICIENT_BUFFER";
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("error", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
