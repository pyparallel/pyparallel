...
#define __PYX_HAVE__avrt
#define __PYX_HAVE_API__avrt
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'avrt' */
#define __Pyx_MODULE_NAME "avrt"
int __pyx_module_is_main_avrt = 0;

/* Implementation of 'avrt' */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initavrt(void); /*proto*/
PyMODINIT_FUNC initavrt(void)
#else
PyMODINIT_FUNC PyInit_avrt(void); /*proto*/
PyMODINIT_FUNC PyInit_avrt(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_avrt(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("avrt", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "avrt")) {
      if (unlikely(PyDict_SetItemString(modules, "avrt", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init avrt", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init avrt");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
