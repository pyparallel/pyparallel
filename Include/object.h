...
_Px_ASSIGNMENT_ERROR(PyObject *container, PyObject *old_value)
{
    ...
    if (old_value == Py_None) {
        _PyParallel_SchedulePyNoneDecref(1);
        return 0;
    }

    PyErr_SetNone(PyExc_AssignmentError);
    return -1;
}
...
__inline
int
_Px_try_read_lock(PyObject *obj)
{
...
__inline
int
_Px_try_write_lock(PyObject *obj)
{
    return TryAcquireSRWLockExclusive((PSRWLOCK)&(obj->srw_lock));
}

#define _Px_READ_LOCK(o)    if (Py_HAS_RWLOCK(o)) _Px_read_lock(o)
#define _Px_READ_UNLOCK(o)  if (Py_HAS_RWLOCK(o)) _Px_read_unlock(o)
#define _Px_WRITE_LOCK(o)   if (Py_HAS_RWLOCK(o)) _Px_write_lock(o)
#define _Px_WRITE_UNLOCK(o) if (Py_HAS_RWLOCK(o)) _Px_write_unlock(o)
*/
#endif /* WITH_PARALLEL */
